# My DSA Notes and Practice Repository
...
## 📂 Practice Problems
This repository also includes solutions for various problems.
- It contains solutions to the famous neetcode 150 sheet
- It contains problems related to most common leetcode patterns like sliding window , prefix sum etc.
...
1. Clone the repo:
2. Navigate to a specific topic or open the relevant `.md` file for notes.
